...
validate_number = RegexValidator(regex=r'^\+?1?\d{2,12}$', message='phone number must be entered in the format +254... up to 12 digits allowed')
...
class OrderDetails(models.Model):
    ...
    address_of_delivery = models.CharField(max_length=50, choices=ADDRESS_OF_DELIVERY, default='Ngara')
    phone_number = models.CharField(null=True, validators=[validate_number], max_length=13)
